...
export default function OrderTrackingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0F0F10] text-white p-6 font-sans flex flex-col justify-between animate-in fade-in duration-300">
      <div className="max-w-md mx-auto w-full flex-grow flex flex-col justify-center py-8">
        <header className="text-center mb-8">
          <span className="text-neutral-500 text-xs font-semibold uppercase tracking-wider">Status Pesanan</span>
