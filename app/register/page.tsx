...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0F0F10] flex items-center justify-center p-4 text-white relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md bg-[#18181B] border border-neutral-800 rounded-2xl p-8 shadow-2xl relative z-10 animate-in fade-in duration-300">
        <div className="mb-6">
          <Link
            href="/login"
            className="inline-flex items-center gap-1.5 text-xs text-neutral-400 hover:text-white transition-all font-semibold"
          >
